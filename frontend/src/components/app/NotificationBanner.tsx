...
const NotificationBanner: React.FC<NotificationBannerProps> = ({
  ...
  }, [autoDismiss, autoDismissTime, isVisible]);
  ...
  const getTypeStyles = (): string => {
    switch (type) {
      case 'info':
        return 'bg-blue-900/30 border-blue-800 text-blue-100';
      case 'warning':
        return 'bg-yellow-900/30 border-yellow-800 text-yellow-100';
      case 'success':
        return 'bg-green-900/30 border-green-800 text-green-100';
      case 'error':
