        ...
        sendTransaction(transaction, {
          onSuccess: async (receipt) => {
            ...
            try {
              ...
              showToast(
                `Borrow transaction confirmed! You earned ${parseFloat(formattedRewards).toFixed(6)} CIRQA rewards!`,
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <button 
              ...
              onClick={() => setAmount(formatUnits(asset.available, asset.decimals))}
            >
              Max
            </button>
          </div>
          <p className="text-xs text-gray-400 mt-1">Available: {formatUnits(asset.available, asset.decimals)} {asset.symbol}</p>
        </div>
